...
$related_posts_heading = pure_blog_get_option( 'related_posts_heading' );
$related_posts_number  = pure_blog_get_option( 'related_posts_number' );
...
$related_ids = apply_filters( 'pure_blog_related_posts', $related_ids, $post_id );
