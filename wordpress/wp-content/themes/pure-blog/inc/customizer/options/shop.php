...
$wp_customize->add_section(
	'section_shop',
	array(
		'title'    => esc_html__( 'Shop', 'pure-blog' ),
		'priority' => 100,
...
$wp_customize->add_control(
	new Radio(
		...
		'theme_options[shop_layout]',
		array(
			'label'    => esc_html__( 'Shop Layout', 'pure-blog' ),
			'section'  => 'section_shop',
			'priority' => 100,
			'choices'  => array(
				'with-sidebar' => esc_html__( 'Sidebar', 'pure-blog' ),
				'no-sidebar'   => esc_html__( 'No Sidebar', 'pure-blog' ),
			),
		)
	)
);
...
$wp_customize->add_control(
	new Number(
		...
		'theme_options[product_per_page]',
		array(
			'label'       => esc_html__( 'Products Per Page', 'pure-blog' ),
			'description' => esc_html__( 'Total number of products shown per page', 'pure-blog' ),
			'section'     => 'section_shop',
			'input_attrs' => array(
				'min'   => 4,
				'max'   => 20,
...
$wp_customize->add_control(
	new Radio(
		...
		'theme_options[product_number]',
		array(
			'label'       => esc_html__( 'Products Per Row', 'pure-blog' ),
			'description' => esc_html__( 'Number of products shown per row', 'pure-blog' ),
			'section'     => 'section_shop',
			'priority'    => 100,
			'choices'     => array(
				'2' => '2',
...
$wp_customize->add_control(
	new Switcher(
		...
		'theme_options[hide_product_sorting]',
		array(
			'label'    => esc_html__( 'Disable Product Sorting Option', 'pure-blog' ),
			'section'  => 'section_shop',
			'priority' => 100,
		)
	)
