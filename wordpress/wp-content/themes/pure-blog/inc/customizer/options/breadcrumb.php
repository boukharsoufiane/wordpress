...
$wp_customize->add_section(
	'section_breadcrumb',
	array(
		'title'    => esc_html__( 'Breadcrumb', 'pure-blog' ),
		'priority' => 100,
...
$wp_customize->add_control(
	new Switcher(
		...
		'theme_options[enable_breadcrumb]',
		array(
			'label'    => esc_html__( 'Enable Breadcrumb', 'pure-blog' ),
...
$wp_customize->add_control(
	new Radio(
		...
		'theme_options[breadcrumb_type]',
		array(
			'label'             => esc_html__( 'Breadcrumb Type', 'pure-blog' ),
			'section'           => 'section_breadcrumb',
			'priority'          => 100,
			'choices'           => array(
				'rankmath' => esc_html__( 'Rank Math', 'pure-blog' ),
				'yoast'    => esc_html__( 'Yoast SEO', 'pure-blog' ),
			),
